...
func baiduStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.MaxAPIError, *dto.Usage) {
	usage := &dto.Usage{}
...
func baiduHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.MaxAPIError, *dto.Usage) {
...
func baiduEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.MaxAPIError, *dto.Usage) {
