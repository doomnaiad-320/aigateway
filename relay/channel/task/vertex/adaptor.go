...
import (
	...
	geminitask "github.com/MAX-API-Next/MAX-API/relay/channel/task/gemini"
	taskcommon "github.com/MAX-API-Next/MAX-API/relay/channel/task/taskcommon"
	vertexcore "github.com/MAX-API-Next/MAX-API/relay/channel/vertex"
...
func (a *TaskAdaptor) BuildRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	fallback := vertexcore.BuildGoogleModelURL(a.baseURL, vertexcore.DefaultAPIVersion, adc.ProjectID, region, modelName, "predictLongRunning")
...
func (a *TaskAdaptor) EstimateBilling(c *gin.Context, info *relaycommon.RelayInfo) map[string]float64 {
	...
	seconds, resolution := geminitask.ResolveVeoBillingInputs(c, req)
