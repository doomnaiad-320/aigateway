...
func ollamaEmbeddingHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.MaxAPIError) {
	...
	embResp := &dto.OpenAIEmbeddingResponse{Object: "list", Data: data, Model: relaycommon.OutputModelName(info), Usage: *usage}
