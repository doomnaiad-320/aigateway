...
func printHelp() {
	fmt.Println("MAX API (Based on OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: MAX-API-Next - https://github.com/MAX-API-Next/MAX-API")
	fmt.Println("Usage: max-api [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
