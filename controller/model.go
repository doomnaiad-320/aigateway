...
import (
	...
	"github.com/MAX-API-Next/MAX-API/relay/channel/ai360"
	"github.com/MAX-API-Next/MAX-API/relay/channel/lingyiwanwu"
...
func ListModels(c *gin.Context, modelType int) {
	...
	if modelLimitEnable {
		// 模型列表来自令牌自身的限制，无需回源查询用户分组
		groups = getContextModelListGroups(c)
	} else {
		var err error
