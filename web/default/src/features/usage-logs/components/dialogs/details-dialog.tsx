...
function AuditContentSection(props: {
  label: string
  content: string
  truncated?: boolean
    ...
    <DetailSection label={props.label}>
      <div className='relative min-w-0'>
        <Button
          ...
          onClick={() => props.onCopy(props.content)}
        ...
        <div className='min-w-0 space-y-1 pr-6'>
          ...
          <pre className='max-h-64 min-w-0 overflow-y-auto font-mono text-[11px] leading-relaxed break-words whitespace-pre-wrap'>
            {props.content}
          </pre>
        </div>
      </div>
