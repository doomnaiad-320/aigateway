...
export type OperationsSettings = {
  RetryTimes: number
  EmptyCompletionRetryEnabled: boolean
...
export type SecuritySettings = {
  ...
  LogRequestContentEnabled: boolean
  LogResponseContentEnabled: boolean
  LogContentMaxCharacters: number
