...
export function usePlaygroundOptions({
  ...
  }, [currentGroup, groupsData, setGroups, updateConfig])
  ...
  }, [currentModel, modelsData, setModels, updateConfig])

  return {
    isLoadingModels,
    currentModels: currentGroup === '' ? undefined : modelsData,
  }
}
