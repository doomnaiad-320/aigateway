                          ...
                          <>
                            <div className='grid gap-4 sm:grid-cols-2'>
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>{t('Task ID Path')}</FormLabel>
                                    <FormControl>
                                      <Input placeholder='task_id' {...field} />
                                    </FormControl>
                                    <FormDescription>
                                      {t('Response path for upstream task ID')}
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
                                )}
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    <FormLabel>{t('Progress Path')}</FormLabel>
                                    <FormControl>
                                      <Input
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormDescription>
                                      {t('Response path for failure reason')}
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
                                )}
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  <FormLabel>{t('Result URL Paths')}</FormLabel>
                                  <FormControl>
                                    <Textarea
                                      rows={2}
