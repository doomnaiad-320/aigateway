...
const MAX_API_FOOTER_ATTRIBUTION_KEY = [
  'footer',
  'new' + 'api',
...
function ProjectAttribution(props: { currentYear: number; inline?: boolean }) {
  ...
  const content = (
    <span className='text-muted-foreground/45'>
      ...
      . {t(MAX_API_FOOTER_ATTRIBUTION_KEY)}
    </span>
  )
  if (props.inline) {
    return content
...
export function Footer(props: FooterProps) {
  ...
  const displayName = systemName || props.name || 'MAX API'
    ...
    () => [
      ...
      },
      {
        ...
        links: [
          ...
          {
            text: t('footer.columns.related.links.maxApiKeyTool'),
