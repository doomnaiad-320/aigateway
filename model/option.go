...
import (
	...
	"github.com/MAX-API-Next/MAX-API/setting/performance_setting"
...
func InitOptionMap() {
	...
	common.OptionMap["LogRequestContentEnabled"] = strconv.FormatBool(common.LogRequestContentEnabled)
	common.OptionMap["LogResponseContentEnabled"] = strconv.FormatBool(common.LogResponseContentEnabled)
	common.OptionMap["LogContentMaxCharacters"] = strconv.Itoa(common.LogContentMaxCharacters)
	...
	common.OptionMap["EmptyCompletionRetryEnabled"] = strconv.FormatBool(common.EmptyCompletionRetryEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "EmptyCompletionRetryEnabled":
			common.EmptyCompletionRetryEnabled = boolValue
		case "AutomaticEnableChannelEnabled":
			common.AutomaticEnableChannelEnabled = boolValue
		case "LogConsumeEnabled":
			common.LogConsumeEnabled = boolValue
		case "LogRequestContentEnabled":
			common.LogRequestContentEnabled = boolValue
		case "LogResponseContentEnabled":
			common.LogResponseContentEnabled = boolValue
	...
	switch key {
	case "LogContentMaxCharacters":
		intValue, _ := strconv.Atoi(value)
		if intValue < 1 {
			intValue = 1
		}
		common.LogContentMaxCharacters = intValue
